    ...
    return (
        <div className="services">
            <div className="section">
                <Intro data={membership.Intro} graphic={Astronaut} />
            </div>
            <div className="section">
                <HowItWorks data={membership.HowItWorks} icon={(<AiOutlineCheckCircle size='25px' style={{ position: 'relative', top: '7px', left: '-10px', opacity: '0.7' }} />)} />
            </div>
            ...
            <div className="section">
                <QA data={membership.QA} link='../Membership' />
            </div>
            <div className="section">
                <QA data={membership.Tuition} link='../Membership' />
            </div>
        </div>
    )
}